...
public class BodySourceView : MonoBehaviour
{
    ...
    private void RefreshBodyObject(Kinect.Body body, GameObject bodyObject)
    {
        for (Kinect.JointType jt = Kinect.JointType.SpineBase; jt <= Kinect.JointType.ThumbRight; jt++)
        {
            ...
            if (targetJoint.HasValue)
            {
                ...
                {
                    var angle = GetAngle(sourceJoint, targetJoint.Value);
    ...
    private static float GetAngle(Kinect.Joint sourceJoint, Kinect.Joint targetJoint)
    {
        var u = GetVector3FromJoint(sourceJoint);
        var v = GetVector3FromJoint(targetJoint);
    ...
    private static float CalculateVectorScalar(Vector3 u, Vector3 v)
    {
        return u.x * v.x + u.y * v.y + u.z * v.z;
    }

    private static float CalculateVectorLength(Vector3 v)
    {
